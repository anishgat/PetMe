      ...
      <section className="rounded-3xl border border-emerald-100 bg-emerald-50/80 p-5 shadow-sm">
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="rounded-2xl border border-emerald-200 bg-white px-3 py-2 text-right">
            ...
            <p className="text-xl font-semibold text-emerald-900">{overallScore.toFixed(1)}</p>
          </div>
        </div>
      ...
      {stepIndex === 0 ? (
        <StepCard>
          ...
          <div className="mt-4 space-y-4">
            ...
            <label className="block">
              <span className="text-sm font-medium text-slate-700">Feeling when awake (1-5)</span>
              <input
                type="range"
                min="1"
                max="5"
